...
export function HeroSection({ profile }: HeroSectionProps) {
  return (
    <section className="relative pt-32 pb-20 px-6 flex flex-col items-center justify-center min-h-screen text-center overflow-hidden">
      <FloatIn delay={0.1}>
        <div className="relative border border-blue-100 p-2 rounded-full mb-8 bg-white/80 backdrop-blur-sm inline-block group shadow-md">
          <div className="relative w-28 h-28 rounded-full bg-linear-to-br from-sky-50 to-blue-100 flex items-center justify-center text-slate-500 shadow-xl group-hover:text-blue-500 transition-colors">
            <Terminal size={48} />
          </div>
        </div>
      </FloatIn>
      ...
      <FadeIn delay={0.4}>
        <h2 className="text-xl md:text-2xl text-slate-600 mb-4 font-light max-w-2xl">
          {profile?.role}
        </h2>
        <p className="text-slate-500 mb-10 max-w-xl text-sm">
      ...
      <FadeIn delay={0.5}>
        <div className="flex gap-4 justify-center flex-wrap">
          ...
          <a
            href="#projects"
            className="px-8 py-3 rounded-full border border-blue-200 text-slate-700 hover:border-blue-400 hover:bg-blue-100/60 transition-all duration-300 font-medium backdrop-blur-sm"
          >
            View Projects
          </a>
        </div>
