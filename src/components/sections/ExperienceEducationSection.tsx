          ...
          <div className="space-y-12">
            {experience?.map((exp) => (
              ...
              >
                ...
                <span className="text-xs text-slate-500 uppercase tracking-wider block mb-3">{exp.duration}</span>
          ...
          <div className="md:mt-0 mt-12">
            ...
            <div className="space-y-12">
              {education?.map((edu) => (
                <div
                  key={edu.id}
                  className="relative pl-8 border-l-2 border-blue-200 hover:border-purple-500 transition-colors duration-300"
                >
                  <div className="absolute -left-2.25 top-0 w-4 h-4 rounded-full bg-white border-2 border-purple-500"></div>
                  ...
                  <span className="text-xs text-slate-500 uppercase tracking-wider">{edu.duration}</span>
                </div>
              ))}
            </div>
          </div>
