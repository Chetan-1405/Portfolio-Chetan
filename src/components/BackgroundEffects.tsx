      ...
      <motion.div
        ...
        style={{
          backgroundImage: `repeating-linear-gradient(
            ...
            transparent,
            transparent 100px,
            rgba(59, 130, 246, 0.06) 100px,
            rgba(59, 130, 246, 0.06) 101px
          )`,
          transform: 'translateZ(0)',
        }}
        animate={{
...
export function GlowOrbs() {
  return (
    <div style={{ willChange: 'auto' }}>
      <motion.div
        className="absolute w-96 h-96 bg-blue-300/30 rounded-full blur-[120px]"
      ...
      />
      <motion.div
        className="absolute w-96 h-96 bg-cyan-300/30 rounded-full blur-[120px]"
      ...
      />
      <motion.div
        className="absolute w-96 h-96 bg-sky-300/25 rounded-full blur-[120px]"
  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      {codeSnippets.map((code, i) => (
        <motion.div
          key={i}
          className="absolute font-mono text-sm text-blue-500/20"
          style={{
            left: `${(i * 15) % 90}%`,
            top: `${(i * 20) % 80}%`,
          }}
